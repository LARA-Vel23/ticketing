            ...
            <div class="card-body">
              <div class="d-flex justify-content-between">
                <div>
                  ...
                  <div class="small text-body-secondary"><span data-coreui-i18n-date="dateOnlyMonthName, { date: '2023, 1, 1'}">January</span> - <span data-coreui-i18n-date="dateOnlyMonthName, { 'date': '2023, 6, 30'}">June</span> 2023</div>
                </div>
              ...
              <div class="c-chart-wrapper" style="height:300px;margin-top:40px;">
                <canvas class="chart" id="main-chart" height="600" width="1636" style="display: block; box-sizing: border-box; height: 300px; width: 818px;"></canvas>
              </div>
            </div>
                      ...
                      <tbody>
                        <tr class="align-middle">
                          ...
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                              ...
                              <div class="text-nowrap small text-body-secondary ms-3"><span data-coreui-i18n-date="dateShortMonthName, { 'date': '2023, 6, 11'}">Jun 11, 2023</span> - <span data-coreui-i18n-date="dateShortMonthName, { 'date': '2023, 7, 10'}">Jul 10, 2023</span></div>
                            </div>
                            <div class="progress progress-thin">
                          ...
                          <td>
                            ...
                            <div class="fw-semibold text-nowrap" data-coreui-i18n="relativeTime, { 'val': -10, 'range': 'seconds' }">10 seconds ago</div>
                          </td>
                          <td>
                            <div class="dropdown">
                        ...
                        <tr class="align-middle">
                          ...
                          <td>
                            ...
                            <div class="small text-body-secondary text-nowrap"><span data-coreui-i18n="recurring">Reccuring</span> | <span data-coreui-i18n="registered">Registered: </span><span data-coreui-i18n-date="dateShortMonthName, { 'date': '2023, 1, 10'}">Jan 10, 2023</span></div>
                          </td>
                          <td class="text-center">
                            <svg class="icon icon-xl">
                        ...
                        <tr class="align-middle">
                          ...
                          <td>
                            <div class="small text-body-secondary" data-coreui-i18n="lastLogin">Last login</div>
                            <div class="fw-semibold text-nowrap" data-coreui-i18n="relativeTime, { 'val': -1, 'range': 'weeks' }">1 week ago</div>
                          </td>
                          <td>
                            <div class="dropdown">
                              <button class="btn btn-transparent p-0 dark:text-high-emphasis" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <tr class="align-middle">
                          ...
                          <td>
                            <div class="d-flex justify-content-between align-items-baseline">
                              ...
                              <div class="text-nowrap small text-body-secondary ms-3"><span data-coreui-i18n-date="dateShortMonthName, { 'date': '2023, 6, 11'}">Jun 11, 2023</span> - <span data-coreui-i18n-date="dateShortMonthName, { 'date': '2023, 7, 18'}">Jul 18, 2023</span></div>
                            </div>
                            <div class="progress progress-thin">
                              <div class="progress-bar bg-info-gradient" role="progressbar" style="width: 22%" aria-valuenow="22" aria-valuemin="0" aria-valuemax="100"></div>
                            </div>
                          ...
                          <td>
                            <div class="small text-body-secondary" data-coreui-i18n="lastLogin">Last login</div>
                            <div class="fw-semibold text-nowrap" data-coreui-i18n="relativeTime, { 'val': -3, 'range': 'months' }">3 months ago</div>
                          </td>
                          <td>
                        ...
                        <tr class="align-middle">
                          ...
                          <td>
                            <div class="small text-body-secondary" data-coreui-i18n="lastLogin">Last login</div>
                            <div class="fw-semibold text-nowrap" data-coreui-i18n="relativeTime, { 'val': -1, 'range': 'years' }">1 year ago</div>
                          </td>
                          <td>
                            <div class="dropdown dropup">
                              <button class="btn btn-transparent p-0 dark:text-high-emphasis" type="button" data-coreui-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
