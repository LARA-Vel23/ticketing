                    ...
                    <table class="table table-hover align-middle m-0">
                        <thead>
                            <tr class="text-uppercase" >
                                <th class="col" style="font-size:0.6em;">{{ __('Merchant ID') }}</th>
                                <th class="col" style="font-size:0.6em;">{{ __('Country ID') }}</th>
                                <th class="col" style="font-size:0.6em;">{{ __('Bank ID') }}</th>
                                <th class="col" style="font-size:0.6em;">{{ __('Admin ID') }}</th>
                                ...
                                <th class="col" style="font-size:0.6em;">{{ __('Notify') }}</th>
